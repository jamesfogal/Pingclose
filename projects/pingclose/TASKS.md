...
#0096 — ❌ citywideheatingair.com — above-the-fold image/content cleanup, never actually audited (client site, not a code task) — start: 2026-08-11. Jim's read: too much content/images above the fold, contributing to the 9.2s LCP, needs a plan to move things below the fold. Flagged during the session but the investigation got pulled into the coupons-page/lead-form bug instead (#0093) and was never followed up. Still open — needs an actual pass: what's above the fold today, what's pushing it, and a concrete move-below-the-fold plan. Full context in projects/pingclose/clients/citywideheatingair.com/NOTES.md.
