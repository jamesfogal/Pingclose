  ...
  return (
    <>
      ...
      <header style={{
        ...
        background: "#0B0E16E6", backdropFilter: "blur(8px)",
        ...
        <a href="/faq" style={{ fontSize: 16, fontWeight: 600, color: "#F1F5F9", textDecoration: "none" }}>Website Speed FAQ</a>
        <a href="/pricing" style={{ fontSize: 16, fontWeight: 600, color: "#10D9A0", textDecoration: "none" }}>See Pricing →</a>
      </header>
    </>
  );
}
