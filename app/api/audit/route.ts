...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!techResult.hasBackup && techResult.cms === 'WordPress') issue(10, '🔴 No backup software detected — if your site is hacked or your host fails, full restoration may be impossible');
